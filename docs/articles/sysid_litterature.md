...
For an introduction to the literature that has influenced this library refer the below citations.
...
discuss some common themes that have guided the development of this library: 
...
- separating between estimation- and validation data, and
...
the author mentions the following open issue within the topic of system identification
...
- automatically polishing data and finding informative portions,
