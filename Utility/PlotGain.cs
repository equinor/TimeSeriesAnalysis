    ...
    public class PlotGain
    {
        ...
        public static void Plot(UnitModel model1, UnitModel model2 = null, double[] uMin=null, double[] uMax=null)
        {
            ...
            for (var inputIdx = 0; inputIdx < model1.ModelInputIDs.Count(); inputIdx++)
            {
                ...
                if (uMin != null && uMax != null)
                {
                    tables_m2 = CreateXYTablesFromModel(model2, model2Name, inputIdx, uMin, uMax);
                }
                else if (model2.modelParameters.Fitting == null)
                {
                    if (model1.modelParameters.Fitting != null)
                        tables_m2 = CreateXYTablesFromModel(model2, model1Name, inputIdx, 
                    ...
                    tables_m2 = CreateXYTablesFromModel(model2, model2Name, inputIdx);
        ...
        static private List<XYTable> CreateXYTablesFromModel(UnitModel model, string modelName, int inputIdx, 
